{inputs, lib, ...}: {
  ...
  programs.noctalia-shell = {
    ...
    settings = lib.mkForce {
      ...
      general = {
        avatarImage = "/home/pegasora/.face";
        dimmerOpacity = 0.2;
      ...
      ui = {
        fontDefault = "Comic Code Ligatures";
        fontFixed = "Comic Code Ligatures";
        fontDefaultScale = 1;
        fontFixedScale = 1;
      ...
      wallpaper = {
        ...
        directory = "/home/pegasora/Wallpapers";
        monitorDirectories = [];
